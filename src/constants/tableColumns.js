...
export const tableColumns = {
  ...
  investor: [
    ...
    {
      Header: 'Ներդրումներ',
      accessor: ({ investments }) => investments
  ...
  treatment: [
    ...
    },
    {
      ...
      accessor: 'treatedProductsIds'
    },
    {
      Header: 'ամսաթիվ',
      accessor: ({ treatmentDate }) => formatDate(treatmentDate)
    },
  ],
  customer: [
    {
  ...
  expense: [
    ...
    {
      Header: 'Ամսաթիվ',
      accessor: ({ expenseDate }) => formatDate(expenseDate)
    },
  ],
  sales: [
    {
      Header: 'Ապրանք',
      accessor: ({ currentProduct }) => currentProduct.name
    },
    {
      Header: 'Քաշ',
      accessor: 'weight'
    ...
    {
      Header: 'Հաճախորդ',
      accessor: ({ currentCustomer }) => `${currentCustomer.name} - ${currentCustomer.phoneNumber}`
    },
    {
