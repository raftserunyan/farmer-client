...
export const loadCommissariats =
...
export const editCommissariat =
	values => async dispatch => {
		try {
			await HttpService.put(
				`commissariat/${values.id}`,
				values
			);
...
export const createCommissariat =
	values => async dispatch => {
		try {
			const createdCommissariat = await HttpService.post(
				'commissariat',
				{
					...values,
